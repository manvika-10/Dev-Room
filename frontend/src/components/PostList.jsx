...
let PostList = () => {
 ...
 useEffect(() => {
  ...
  let submitCreatePost = async(e) => {
    ...
    {
      const {data} =  await axios.post("https://devconnect-backend-nno6.onrender.com/api/posts/",localPost,{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
  ...
  let clickDeletePost = async (postId) => {
    const { data } = await axios.delete(`https://devconnect-backend-nno6.onrender.com/api/posts/${postId}`, {
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      },
  ...
  let clickLikePost = async(postId) => {
    await axios.put(`https://devconnect-backend-nno6.onrender.com/api/posts/like/${postId}`,{},{
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("devconnect")}`,
      }
